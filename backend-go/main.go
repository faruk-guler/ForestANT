...
func main() {
	...
	// FIX: Path artık DATA_PATH env'den veya executable dizininden çözümleniyor
	// "backend-go/data/domains.json" hard-coded path Windows'a özgüydü
	dataPath := os.Getenv("DATA_PATH")
	if dataPath == "" {
		dataPath = "data/domains.json"
	}
	s := storage.NewFileStorage(dataPath)
	api.DomainStorage = s
