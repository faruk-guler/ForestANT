...
function App() {
  ...
  const bulkDeleteDomains = async (ids: number[]) => {
    if (!confirm(`Are you sure you want to delete ${ids.length} selected domains?`)) return;
    try {
      setLoading(true);
    ...
    <div className="app-layout">
      <aside className="sidebar">
        <div className="sidebar-logo" onClick={() => setActiveTab('dashboard')} style={{ cursor: 'pointer' }}>
          <img src="/ant-logo.png" alt="DominANT" className="logo-img" />
        ...
        <div style={{ marginBottom: '1.25rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: '0.2rem' }}>
           ...
           <button 
             onClick={toggleTheme} 
             className="btn-icon" 
             style={{ background: 'var(--input-bg)', padding: '0.5rem', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            ...
            <div className="card about-card-minimal">
              <div className="about-content">
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '2rem' }}>
                  ...
                  <h2 style={{ fontSize: '2rem', fontWeight: '800', letterSpacing: '-0.5px' }}>DominANT v3.0</h2>
                </div>
                ...
                <div className="mission-text-minimal">
                  DominANT provides real-time oversight of SSL/TLS certificate lifecycles 
                ...
                <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', opacity: 0.7 }}>
                  <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>© 2026 DominANT Monitoring • All Rights Reserved</div>
